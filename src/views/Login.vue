<template>
  <AuthCard v-if="!['success_login', 'user_fetch'].includes(currentState.value)">
    <template #default>
      <KAlert
      ...
      <div
        v-if="[ 'idle','error'].includes(currentState.value) && redirectTo"
    ...
    <template
      v-if="isBasicAuthEnabled && ['idle','error'].includes(currentState.value)"
      #below-card
    >
      <span
...
export default defineComponent({
  ...
  setup () {
    ...
    const onVerifyEmailSuccess = (event = {}) => {
